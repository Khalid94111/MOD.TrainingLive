...
export class CasualCourseService {
  ...
  calculatePreview = (input: CalculatePreviewInput, config?: Partial<Rest.Config>) =>
    this.restService.request<any, CalculatePreviewDto>({
      method: 'POST',
      url: '/api/app/casual-course/calculate-preview',
      body: input,
    },
    { apiName: this.apiName,...config });
